...
export class _Blank extends React.Component {
  ...
  render = () => (
    <View style={styles.View_1}>
      <Text style={styles.Text_3}>Boat Details</Text>
      <TextInput
        placeholder="Name"
        editable={true}
      ...
      <TextInput
        placeholder="Draft"
        editable={true}
        style={styles.TextInput_23}
        value={this.state.TextInput_23}
        onChangeText={nextValue => this.setState({ TextInput_23: nextValue })}
      />
      <Text style={styles.Text_32}>Power Details</Text>
      <TextInput
        placeholder="HP"
        editable={true}
        keyboardType="numeric"
        style={styles.TextInput_29}
      ...
      <TextInput
        placeholder="Manufacturer"
        editable={true}
        style={styles.TextInput_34}
        value={this.state.TextInput_34}
        onChangeText={nextValue => this.setState({ TextInput_34: nextValue })}
      />
      <CheckBox
        title="Twins?"
        disabled={false}
        containerStyle={styles.CheckBox_41}
        checked={this.state.CheckBox_41}
        onPress={nextChecked => this.setState({ CheckBox_41: nextChecked })}
      />
      <Button
        title="Save"
        color="#3366FF"
        style={styles.Button_25}
